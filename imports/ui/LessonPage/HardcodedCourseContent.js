...
const IntroduccionLessonRaw = [
  {
    type: 'content',
    imageUrl: '/images/lessons/code-window',
    title: 'Empecemos!',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/joystick',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/todo-list',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/code-pc',
...
Las computadoras son torpes, lo único que saben hacer es seguir instrucciones.`,
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/binary',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/google',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/ranking',
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/write-code',
...
const PrimerosConceptosLessonRaw = [
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/pendrive',
    title: 'Variables',
...
* Mostrarle al usuario \`\`\`numero1 + numero2\`\`\``,
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/decision',
    title: 'If y else',
...
1. \`\`\`pasoActual = 1\`\`\``,
  ...
  {
    type: 'content',
    imageUrl: '/images/lessons/finish',
